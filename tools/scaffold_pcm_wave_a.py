...
SPECS = (
    ...
    Spec("caf-pcm-to-au-pcm", "Caf", "Au", "exfmt:audio:caf-pcm", "exfmt:audio:au-pcm", "Core Audio Format PCM", "Sun AU/SND PCM"),
    Spec("au-pcm-to-caf-pcm", "Au", "Caf", "exfmt:audio:au-pcm", "exfmt:audio:caf-pcm", "Sun AU/SND PCM", "Core Audio Format PCM"),
    Spec("caf-pcm-to-rf64-pcm", "Caf", "Rf64", "exfmt:audio:caf-pcm", "exfmt:audio:rf64-pcm", "Core Audio Format PCM", "RF64 PCM"),
    Spec("rf64-pcm-to-caf-pcm", "Rf64", "Caf", "exfmt:audio:rf64-pcm", "exfmt:audio:caf-pcm", "RF64 PCM", "Core Audio Format PCM"),
    Spec("caf-pcm-to-bw64-pcm", "Caf", "Bw64", "exfmt:audio:caf-pcm", "exfmt:audio:bw64-pcm", "Core Audio Format PCM", "BW64 PCM"),
    Spec("bw64-pcm-to-caf-pcm", "Bw64", "Caf", "exfmt:audio:bw64-pcm", "exfmt:audio:caf-pcm", "BW64 PCM", "Core Audio Format PCM"),
    Spec("caf-pcm-to-wave64-pcm", "Caf", "Wave64", "exfmt:audio:caf-pcm", "exfmt:audio:wave64-pcm", "Core Audio Format PCM", "Sony Wave64 PCM"),
    Spec("wave64-pcm-to-caf-pcm", "Wave64", "Caf", "exfmt:audio:wave64-pcm", "exfmt:audio:caf-pcm", "Sony Wave64 PCM", "Core Audio Format PCM"),
    Spec("caf-pcm-to-bwf-pcm", "Caf", "Bwf", "exfmt:audio:caf-pcm", "exfmt:audio:bwf-pcm", "Core Audio Format PCM", "Broadcast WAVE PCM"),
    Spec("bwf-pcm-to-caf-pcm", "Bwf", "Caf", "exfmt:audio:bwf-pcm", "exfmt:audio:caf-pcm", "Broadcast WAVE PCM", "Core Audio Format PCM"),
    Spec("au-pcm-to-rf64-pcm", "Au", "Rf64", "exfmt:audio:au-pcm", "exfmt:audio:rf64-pcm", "Sun AU/SND PCM", "RF64 PCM"),
    Spec("rf64-pcm-to-au-pcm", "Rf64", "Au", "exfmt:audio:rf64-pcm", "exfmt:audio:au-pcm", "RF64 PCM", "Sun AU/SND PCM"),
    Spec("au-pcm-to-bw64-pcm", "Au", "Bw64", "exfmt:audio:au-pcm", "exfmt:audio:bw64-pcm", "Sun AU/SND PCM", "BW64 PCM"),
    Spec("bw64-pcm-to-au-pcm", "Bw64", "Au", "exfmt:audio:bw64-pcm", "exfmt:audio:au-pcm", "BW64 PCM", "Sun AU/SND PCM"),
    Spec("au-pcm-to-wave64-pcm", "Au", "Wave64", "exfmt:audio:au-pcm", "exfmt:audio:wave64-pcm", "Sun AU/SND PCM", "Sony Wave64 PCM"),
    Spec("wave64-pcm-to-au-pcm", "Wave64", "Au", "exfmt:audio:wave64-pcm", "exfmt:audio:au-pcm", "Sony Wave64 PCM", "Sun AU/SND PCM"),
    Spec("au-pcm-to-bwf-pcm", "Au", "Bwf", "exfmt:audio:au-pcm", "exfmt:audio:bwf-pcm", "Sun AU/SND PCM", "Broadcast WAVE PCM"),
