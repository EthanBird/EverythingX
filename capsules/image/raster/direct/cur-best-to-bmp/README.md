...
Independent, zero-dependency Rust conversion from best-ranked Windows CUR member to
Windows BMP raster. GIF parsing covers LZW, interlace, global/local palettes,
