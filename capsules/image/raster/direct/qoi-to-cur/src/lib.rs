...
const SOURCE: Profile = Profile::Qoi;
const TARGET: Profile = Profile::Cur;
...
mod tests {
    ...
    fn malformed_signature_is_rejected() {
        ...
        assert!(matches!(error, Error::InvalidSignature(_) | Error::Truncated(_) | Error::Png(_) | Error::Legacy(_)));
    }
