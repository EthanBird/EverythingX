# bw64-pcm-to-aiff-pcm

Independent, zero-dependency Rust conversion from BW64 PCM to
classic AIFF PCM. The crate parses the source container, validates integer
